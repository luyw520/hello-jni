package com.example.lu.recyclerview;
...
import com.example.lu.recyclerview.base.ItemViewDelegateForRV;
import com.example.lu.recyclerview.base.ItemViewDelegateManagerForRV;
...
public class MultiItemTypeAdapterForRV<T> extends RecyclerView.Adapter<CommonRecyclerViewHolder> {
    ...
    public CommonRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ItemViewDelegateForRV itemViewDelegate = mItemViewDelegateManager.getItemViewDelegate(viewType);
        int layoutId = itemViewDelegate.getItemViewLayoutId();
        CommonRecyclerViewHolder holder = CommonRecyclerViewHolder.createViewHolder(mContext, parent, layoutId);
...
//    public MultiItemTypeAdapterForRV addItemViewDelegate(ItemViewDelegateForRV<T> itemViewDelegate) {
//        mItemViewDelegateManager.addDelegate(itemViewDelegate);
//        return this;
//    }

    public MultiItemTypeAdapterForRV addItemViewDelegate(int viewType, ItemViewDelegateForRV<T> itemViewDelegate) {
