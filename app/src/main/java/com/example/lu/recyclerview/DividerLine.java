...
public class DividerLine extends RecyclerView.ItemDecoration {
    ...
    public DividerLine(Context context, int orientation, int paddingLeft, int paddingRight) {
        ...
        this.paddingRight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingRight, context.getResources().getDisplayMetrics());
        paint = new Paint();
    }
